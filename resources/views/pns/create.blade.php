...
<form action="/pns" method="post" enctype="multipart/form-data">
    @csrf 
    <div class="box-body">
        <div class="mb-3" >
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('id') is-invalid @enderror" id="id" placeholder="id " name="id" value="{{ old('id') }}">
